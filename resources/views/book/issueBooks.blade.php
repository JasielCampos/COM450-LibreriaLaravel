...
<div id="admin-content">
  <div class="container">
    <div class="row">
      <div class="col-md-3">
        <h2 class="admin-heading">Libros Prestados</h2>
      </div>
    
    <div class="offset-md-6 col-md-2">
        <a class="add-new" href="{{ route('book_issue.create') }}">Prestar Libro</a>
    </div>
    </div>
    <div class="row">
      <div class="col-md-12">
    ...
    <div class="text-left" style="padding-left: 210px; padding-top: 10px;">
        <a target="_red" class="btn btn-danger px-3 py-2 text-white"  onclick="generateCharts()">Generar Gráfica</a>
    </div>
    <!-- <div class="row mt-5">
    ...
    <div class="col-md-4" style="padding-left: 210px;padding-top: 10px;">
    <h2 class="admin-heading">Estado de Libros</h2>
    </div>
